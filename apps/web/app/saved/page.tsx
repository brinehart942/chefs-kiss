...
export default function SavedPage() {
  ...
  const pageData = getPageByName("Saved Collections");
  ...
  return (
    <PageLayout title="Saved Collections" description="Bookmark recipes">
      <PageInfo
        purpose={pageInfo?.purpose || "Bookmark recipes"}
        roleVisibility={
